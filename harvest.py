...
import urllib3
import json as json2 #TODO: rename
...
cbs_open_data_response = http.request('GET', 'https://opendata.cbs.nl/ODataApi/OData/84734NED/Woonplaatsen')

json = json2.loads(cbs_open_data_response.data, object_hook=lambda d: SimpleNamespace(**d))
...
for municipality in municipalities:
    ...
    with open(f'data/{municipality}.json', 'w', encoding='utf-8') as f:
        json2.dump([house.__dict__ for house in houses], f, indent=2)
